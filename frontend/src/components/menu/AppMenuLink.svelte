...
{#if menuItem.subtle === undefined || menuItem.subtle === false}
  <a href={menuItem.href}><li class="bright">{menuItem.text}</li></a>
{:else}
  <a href={menuItem.href}><li class="subtle">{menuItem.text}</li></a>
{/if}
